...
//a_os << "refineThresh        =" << a_p.m_refineThresh        << endl;
  ...
  if (tagOnEnergy)
    {
      a_os<< "tagging energy with threshhold =" << a_p.m_gradEnergyRefineThresh << endl;
    }

  if (tagOnDensity)
    {
      a_os<< "tagging density with threshhold =" << a_p.m_gradDenseRefineThresh << endl;
    }

  if (tagOnVorticity)
    {
      a_os<< "tagging vorticity with threshhold =" << a_p.m_vorticityRefineThresh << endl;
    }
