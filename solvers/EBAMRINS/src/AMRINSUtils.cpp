                    ...
                    ProblemDomain&   a_coarsestInputDomain)
{
  ...
  if (a_params.m_doSFD)
    {
      ppebamr.get("restart_SFD", a_params.m_restartSFD);
      ppebamr.get("plot_SFD", a_params.m_plotSFD);
      ppebamr.get("nFilters", a_params.m_nFilters);
      ppebamr.get("smallest_filter", a_params.m_smallestFilter);
